...
import (
	"database/sql"
	"go-projects/inventory/client"
	"go-projects/inventory/postgres"
	"go-projects/inventory/transport/http"
	"go-projects/inventory/transport/rpc"
	"log"
	"net"
)
...
func main() {
	...
	// supplier service
	acmeClient := client.NewClient("https://acme.com/api")
